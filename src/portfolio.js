...
export const greetings = {
  ...
  description:
    "Nice to meet you! I'm Caíque, a passionate developer, currently working as Quality Software at Zé Delivery, but also an App Developer on weekends and a Data Scientist on free time",
  resumeLink:
    "https://drive.google.com/file/d/1IBRSOQzzDqXBAYCDNPf2lDpwcuRaYlOp/view?usp=sharing",
};
...
export const experience = [
  {
    ...
    desc: "Lead a team of 6 SDETs and provide mentorship and guidance for their professional development. Develop and implement automated testing strategies and frameworks using Cypress for web application testing.",
    descBullets: [
      "Design, develop and maintain automated tests including smoke and regression tests.",
      "Perform defect triage and work with the development team to resolve issues in a timely manner.",
      "Monitor application performance using tools such as Granafa and Sentry to identify and resolve performance bottlenecks.",
      "Conduct performance testing using locust and k6 to identify and mitigate performance issues.",
      "Manage and execute test cases using qase.io integrated with Cypress to ensure high-quality releases.",
    ],
  },
  {
